...
alias kas='(export KUBECONFIG=~/.kube/aws-stage && k9s)'
alias kap='(export KUBECONFIG=~/.kube/aws-prod && k9s)'
alias kah='(export KUBECONFIG=~/.kube/hungary && k9s)'
alias k9s="K9S_CONFIG_DIR=$HOME/.config/k9s XDG_CONFIG_HOME=$HOME/.config/ k9s"
...
alias ,,='noglob aichat -r shell-no-think -e'
alias s='kitten ssh'
